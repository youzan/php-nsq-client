...
return [
    ...
    'nsq.server.lookupd.lookupd-queue' => ['http://127.0.0.1:1'],
    ...
    'nsq.server.lookupd.lookupd-dsn-discovery-non' => ['http://127.0.0.2:7'],
    ...
    'nsq.server.lookupd.global-dcc-odd' => ['dcc://local/parameters?query=%s.nsq.lookupd.addr~%s&fallback=http://127.0.0.3:12345'],
